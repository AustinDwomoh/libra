...
def collect_jobs():
    return [
        {"title": "Software Engineer", "company": "TechCorp", "location": "Remote",
         "description": "Looking for experience with Python, Django, REST APIs"},
        {"title": "Frontend Developer", "company": "WebWorks", "location": "New York",
         "description": "React, CSS, UX design skills needed"},
    ]
